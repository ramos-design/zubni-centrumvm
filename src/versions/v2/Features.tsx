          ...
          <div className="lg:col-span-5 relative">
            <div className="sticky top-32">
              ...
              <motion.div 
                ...
                className="mt-12 relative w-full aspect-[4/3] rounded-md overflow-hidden shadow-sm hidden lg:block bg-slate-100"
              >
                <AnimatePresence>
                  <motion.img
                    key={activeIndex}
            ...
            <div className="flex flex-col gap-24 py-12 lg:py-48">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <div className="lg:hidden w-full aspect-video rounded-md overflow-hidden bg-slate-100 mb-8 relative">
                     <img 
                       src={feature.image} 
                       alt={feature.title}
                       className="absolute inset-0 w-full h-full object-cover"
                  ...
                  >
                    <div className={`absolute top-0 left-0 -translate-x-1/2 w-4 h-4 rounded-[2px] border-4 border-white transition-colors duration-500 ${activeIndex === index ? 'bg-primary-500' : 'bg-primary-100'}`}></div>

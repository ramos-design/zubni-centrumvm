      ...
      >
        ...
        <div className="hidden md:flex items-center gap-4">
          <a 
            ...
            className={`morphglass-btn-primary group inline-flex items-center gap-2 rounded-full text-xs font-bold uppercase tracking-widest ${scrolled ? 'px-6 py-2.5' : 'px-8 py-3.5'}`}
          >
        ...
        <div className="flex md:hidden items-center">
          <button
            ...
            className="morphglass-btn text-primary-900 p-2 rounded-full focus:outline-none"
            aria-expanded="false"
          >
            ...
            <div className="px-6 py-8 flex flex-col gap-6">
              ...
              <div className="pt-6 border-t border-slate-100">
                <a 
                  ...
                  href="tel:+420123456789"
                  className="morphglass-btn-primary flex items-center justify-center gap-3 w-full py-5 rounded-2xl text-base font-bold uppercase tracking-widest"
                >
